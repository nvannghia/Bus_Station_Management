<%-- 
    ...
    Created on : Aug 27, 2023, 1:55:21 PM
    Author     : nghia
--%>
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Thêm địa chỉ</p>
                                <c:url value="/location/add" var="action" />
                                <form:form modelAttribute="location" class="mx-1 mx-md-4" method="post" action="${action}">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <form:errors path="districtName" element="div" cssClass="text-danger" />
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <form:errors path="streetName" element="div" cssClass="text-danger" />
